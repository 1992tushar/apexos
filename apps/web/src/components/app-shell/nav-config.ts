...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Leads", href: "/leads", icon: Target, active: true, section: "work" },
  ...
  { label: "Reports", href: "/reports", icon: BarChart3, active: true, section: "work" },
  { label: "Analytics", href: "/analytics", icon: LineChart, active: true, section: "work" },
